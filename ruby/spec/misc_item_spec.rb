...
describe "Misc item" do
  describe "Update_quality" do
    ...
    context "Sell_in" do
      it "reduces sell_in by one" do
        item = MiscItem.new("Delicious pear", 10, 50)
        item.update_quality()
  ...
  describe "#to_s" do
    it "should return a string containing the item's class, sell_in and quality" do
      rubber_duck = MiscItem.new("Delicious pear", 5, 9)
