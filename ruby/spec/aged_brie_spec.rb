...
describe "Aged Brie" do
  ...
  describe "#to_s" do
    it "should return a string containing the item's name, sell_in and quality" do
      cheese = AgedBrie.new(name: "Aged Brie", sell_in: 5, quality: 9)
      expect(cheese.to_s).to eq "Aged Brie, 5, 9"
    end
  end
end
