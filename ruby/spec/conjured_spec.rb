...
describe "Conjured" do
  ...
  describe "#to_s" do
    it "should return a string containing the item's name, sell_in and quality" do
      conjured_staff = Conjured.new(name: "Conjured staff", sell_in: 5, quality: 9)
